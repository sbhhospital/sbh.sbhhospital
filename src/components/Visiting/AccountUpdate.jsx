...
const AccountUpdate = ({ scriptUrl }) => {
        ...
        return (
            <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-10">
                <div className="relative">
                    <div className="w-20 h-20 border-4 border-orange-100 rounded-full animate-spin border-t-orange-600"></div>
                    <IndianRupee className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-orange-600" size={28} />
                </div>
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center p-4 sm:p-10 font-sans selection:bg-orange-500 selection:text-white">
            {!success ? (
                <div className="w-full max-w-xl bg-white rounded-[3.5rem] border border-slate-100 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.06)] overflow-hidden relative">
                    ...
                    <div className="relative z-10 mb-14 text-center">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-slate-800 tracking-tighter uppercase mb-4 leading-none">
                            Confirm <span className="bg-gradient-to-r from-orange-600 to-amber-500 bg-clip-text text-transparent underline decoration-orange-400 underline-offset-8">Settlement</span>
                        </h2>
                    ...
                    <div className="p-10 md:p-14 space-y-12 relative z-10">
                        ...
                        <div className="bg-slate-50 rounded-[2rem] p-8 border border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div className="space-y-2">
                                <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] flex items-center gap-2"><User size={12} className="text-orange-500" /> Consultant</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-10">
                            <div className="space-y-4">
                                ...
                                <div className="relative group">
                                    <IndianRupee className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-orange-500 transition-colors" size={20} />
                                    <input 
                                        required 
                                        type="number" 
                                        value={formData.paidAmount} 
                                        onChange={e => setFormData({...formData, paidAmount: e.target.value})} 
                                        className="w-full bg-slate-50 border-2 border-slate-50 rounded-3xl p-6 pl-16 text-slate-800 text-2xl font-black focus:border-orange-500/20 focus:bg-white transition-all outline-none shadow-inner" 
                                        placeholder="0" 
                                    />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-4">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-slate-50 border-2 border-slate-50 rounded-3xl p-5 text-slate-800 font-black focus:border-orange-500/20 focus:bg-white transition-all outline-none uppercase text-xs" 
                                    />
                                </div>
                                <div className="space-y-4">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-slate-50 border-2 border-slate-50 rounded-3xl p-5 text-slate-800 font-black focus:border-orange-500/20 focus:bg-white transition-all outline-none text-xs" 
                            ...
                            <button 
                                disabled={submitting} 
                                type="submit" 
                                className="w-full py-7 bg-slate-900 text-white rounded-[2.5rem] font-black uppercase tracking-[0.3em] text-[11px] hover:bg-orange-600 transition-all shadow-2xl shadow-slate-200 disabled:opacity-50 active:scale-[0.98] flex items-center justify-center gap-4 group"
                            >
                ...
                <div className="w-full max-w-xl bg-white rounded-[4rem] p-16 text-center border border-orange-50 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] relative overflow-hidden">
                    <div className="relative z-10">
                        <div className="w-28 h-28 bg-gradient-to-br from-orange-500 to-amber-400 rounded-[2.5rem] mx-auto flex items-center justify-center text-white mb-10 shadow-2xl shadow-orange-200 rotate-6">
                            <Award size={56} />
                        </div>
                        
                        <h2 className="text-4xl md:text-5xl font-black text-slate-800 uppercase tracking-tighter leading-none mb-4">
                            Ledger <span className="text-orange-600">Updated!</span>
                        </h2>
                        ...
                        <div className="bg-slate-50 rounded-[3rem] p-8 border border-slate-100 mb-10 flex flex-col items-center">
                            ...
                            <div className="mt-4 px-4 py-1.5 bg-white rounded-full border border-slate-200 text-[9px] font-black text-orange-600 uppercase tracking-widest flex items-center gap-2">
                        ...
                        <button 
                            ...
                            className="px-10 py-4 bg-slate-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-orange-600 transition-all shadow-xl shadow-slate-200 flex items-center gap-3 mx-auto"
                        >
